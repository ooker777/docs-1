...
- You can, also, create some CSS customization with hashtag, with editing `docs/assets/css/custom_attributes.css`. See [[../Template - The blog/customization and css#custom-attribute]] for some example.

## Folder note

To support the citation and link to these page, you need to use an index key (cf [[../OBS2MK - Python in terminal/usage#script-s-configuration]]).
